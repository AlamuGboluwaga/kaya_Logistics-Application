...
const { truckAvailabilitySchema, orderPaymentSchema, orderSchema, orderWaybillSchema, alterOrderWaybillSchema, alterPaymentSchema } = require('./schemas/orderschema')
